...
def strokeFilter(im, orient, freq, kx, ky):
    ...
    maxIndex = int(180 / angleInc) # convert to int according to the spec of the arg of range fn.
    for o in range(0, maxIndex):
        rot_filt = scipy.ndimage.rotate(reffilter, -(o * angleInc + 90), reshape=False)
        gabor_filter[o] = rot_filt
    maxsze = int(sze) # covert to int
